...
export default function TravelNotes() {
  return (
    <section className="bg-bone">
      {/* Scenic band, roughly half the viewport. */}
      <div className="relative h-[48vh] min-h-[300px] w-full overflow-hidden">
        ...
        />
        {/* Fades the photo into the page below it. */}
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-bone to-transparent" />
      </div>

      <Container className="pb-20 pt-14 text-center sm:pb-28 lg:pb-32">
        ...
        <p className="mx-auto mt-5 max-w-2xl leading-relaxed text-ink-soft">
          Twelve years of planning trips has taught us that the small decisions
          made weeks before departure are the ones that shape the journey.
        </p>
